...
StateMachineState ICE_AGENT_STATE_MACHINE_STATES[] = {
        ...
        {ICE_AGENT_STATE_WAITING_REMOTE_CREDENTIAL, ICE_AGENT_STATE_NEW | ICE_AGENT_STATE_WAITING_REMOTE_CREDENTIAL, fromWaitingRemoteCredentialIceAgentState, executeWaitingRemoteCredentialIceAgentState, INFINITE_RETRY_COUNT_SENTINEL, STATUS_ICE_INVALID_STATE},
